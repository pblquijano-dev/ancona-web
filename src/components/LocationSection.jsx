              ...
              <div>
                ...
                <div className="flex gap-6">
                  <a
                    ...
                    aria-label="Instagram de Ancona Joyería"
                  >
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="w-14 h-14 bg-primary flex items-center justify-center rounded-full text-white hover:bg-secondary transition-all shadow-md"
                    aria-label="Facebook de Ancona Joyería"
                  >
                    <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" aria-hidden="true">
            ...
            >
              <div className="absolute inset-0 bg-primary/20 backdrop-blur-[1px] flex items-center justify-center p-6">
                <div className="bg-white/95 backdrop-blur-md p-6 shadow-2xl text-center max-w-xs border border-secondary/30 rounded-md">
                  <span className="material-symbols-outlined text-secondary text-4xl mb-2 block animate-bounce" aria-hidden="true">
                    location_on
                  </span>
                  <h4 className="font-headline text-lg text-primary mb-1">{STORE_CONFIG.name}</h4>
                  <p className="text-xs text-on-surface-variant mb-4">{STORE_CONFIG.address.full}</p>
                  <a
                    href={STORE_CONFIG.social.googleMaps}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block bg-primary text-white px-5 py-2.5 text-label-caps text-[10px] hover:bg-secondary transition-colors font-semibold"
                  >
                    Google Maps →
                  </a>
                </div>
